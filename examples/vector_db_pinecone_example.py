...
This example demonstrates how to use the PineconeVectorIndex implementation
...
def main():
    ...
    # 2. Create Pinecone vector index instance
    print("\n[2] Creating Pinecone vector index...")
    vector_index = PineconeVectorIndex(embeddings=embeddings)
    print("✓ Pinecone vector index created")
    ...
    print("✓ VectorStoreSingleton initialized with Pinecone")
